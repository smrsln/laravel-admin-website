        ...
        <div class="modal fade" id="{!!$veri->id!!}" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                  <img class="img-responsive center-block" src="/bacifoto/{!!$veri->id!!}" >
                  <div class="caption">
                    <h3 style="text-align:center; margin-top: 20px;">{!! $veri->baci_ad_soyad !!}</h3>
                    <div style="padding: 0 30px 30px 30px;">
                    <p style="text-align: justify;">{!! $veri->baci_ozgecmis !!}</p>                    	
                    </div>
                  </div>
              </div>
            </div>
        ...
        @endforeach
          <div class="row">
            ...
            <div class="col-sm-6 col-md-4 ayar">
                <div class="thumbnail">
                  <img style="border-radius: 5%" src="/bacifoto/{!!$veri->id!!}" >
                  <div class="caption">
                    <h3 style="text-align:center;">{!! $veri->baci_ad_soyad !!}</h3>
                    <p>{!! str_limit(strip_tags($veri->baci_ozgecmis), 150) !!}</p>
                    @if(strlen($veri->baci_ozgecmis) > 150 )
