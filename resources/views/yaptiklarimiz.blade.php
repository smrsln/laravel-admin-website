      ...
      <div class="container">
        ...
        @foreach($veriler as $key => $veri)
            ...
            <div class="news-timeline-box"><strong class="date"><span></span></strong>
              <div class="text-box">
                <div class="holder">
                  <h3><a href="etkinlikicerik/{!! $veri->slug !!}">{!! $veri->baslik !!} </a></h3>
                  
                  <p>{!! str_limit( strip_tags($veri->yazi), 180 ) !!}</p>
                  <a href="etkinlikicerik/{!! $veri->slug !!}" class="btn-readmore">Tamamını Gör</a> </div>
                <div class="thumb"><img src="/etkinlikmain/{!!$veri->id!!}" alt="img" height="288" width="251"></div>
              </div>
            </div>
