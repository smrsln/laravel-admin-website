...
$errors = '';
$myemail = 'bilgi@yorukturkmenbirligi.org';
if(empty($_POST['isim'])  || 
   empty($_POST['email']) || 
   empty($_POST['konu']) ||
   empty($_POST['mesaj']))
...
if( empty($errors))
{
	$email_body = "Yörük Türkmen Birliği iletişim formundan yeni başvurunuz var. <br>".
	" Detaylar:<br> İsim: $isim <br> Email: $email_address <br> Konu: $konu <br> Mesaj: $mesaj"; 
...
<html>
<head>
	<title>iletisim form degerlendir</title>
</head>
